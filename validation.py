...
def validate_model_description(model_description: ModelDescription, validate_variable_names: bool = False, validate_model_structure: bool = False) -> List[str]:
    ...
    for variable in model_description.modelVariables:
        # print("进来了variable.type是",variable.type,"variable.name是",variable.name)
        if variable.type not in {'RealArray', 'Integer', 'Real', 'Float32', 'Float64'} and variable.variability == 'continuous':
